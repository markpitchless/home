...
"	* This scripts needs the ShowLine function from vinscripts#381
"
" $Header: /usr/home/gary/.vim/autoload/RCS/ShowBlockName.vim,v 1.6 2002/08/15 22:47:08 gary Exp $

"
" Setup vim to call function
"=============================================================================
" TODO: Can we do this better than just when the cursor doesn't move for ages?
" Trapping movement, mode change etc?
